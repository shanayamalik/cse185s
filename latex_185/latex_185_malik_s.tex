...
In \LaTeX, an acknowledgments section can be included through using the \texttt{\textbackslash section\{Acknowledgments\}} command. Th section often comes just before the references section.
